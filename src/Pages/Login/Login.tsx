      ...
      <div className='flex flex-col w-[90%] md:w-[85%] py-12 items-center gap-10'>
        <form onSubmit={handleSubmit} className='grid grid-cols-1 xl:grid-cols-2 gap-8 w-[90%] md:w-4/5 lg:w-3/5'>
          ...
          <button
            type='submit'
            disabled={loading}
            className={`flex w-fit px-3 py-1.5 gap-3 xl:col-start-2 justify-self-end items-center rounded text-xl font-semibold cursor-pointer ${
            ...
            <svg viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='2' strokeLinecap='round' className='h-6'>
              <path d='M10 17L15 12M15 12L10 7M15 12H3M15 3H19C19.5304 3 20.0391 3.21071 20.4142 3.58579C20.7893 3.96086 21 4.46957 21 5V19C21 19.5304 20.7893 20.0391 20.4142 20.4142C20.0391 20.7893 19.5304 21 19 21H15' />
            </svg>
          </button>
        </form>
