      ...
      <div className='flex py-12 items-center gap-6 lex-wrap justify-center xl:gap-10'>
        <div className='flex flex-col items-center justify-center px-10 md:px-0 gap-3 bg-surface-primary dark:bg-surface-secondary transition-all duration-400 rounded-2xl font-bold w-[360px] h-[500px]'>
          ...
          <div className='flex gap-8'>
            <a
              ...
              target='_blank'
              className='bg-brand hover:bg-brand-hover focus:bg-brand-focus transition-all duration-400 p-3 rounded-full'>
        ...
        <div className='flex flex-col items-center justify-center px-10 md:px-0 gap-3 bg-surface-primary dark:bg-surface-secondary transition-all duration-400 rounded-2xl font-bold w-[360px] h-[500px]'>
          ...
          <div className='flex gap-8'>
            ...
            <a
              href='https://www.linkedin.com/in/jos%C3%A9-diogo-d-33634b280'
              target='_blank'
              className='bg-brand hover:bg-brand-hover focus:bg-brand-focus transition-all duration-400 p-3 rounded-full'>
              <svg viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='2' strokeLinejoin='round' className='h-7'>
                <path d='M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z' />
        ...
        <div className='flex flex-col items-center justify-center px-10 md:px-0 gap-3 bg-surface-primary dark:bg-surface-secondary transition-all duration-400 rounded-2xl font-bold w-[360px] h-[500px]'>
          ...
          <div className='flex gap-8'>
            ...
            <a
              href='https://www.linkedin.com/in/pedro-henrique-miranda-de-vasconcelos/'
              target='_blank'
              className='bg-brand hover:bg-brand-hover focus:bg-brand-focus transition-all duration-400 p-3 rounded-full'>
              <svg viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='2' strokeLinejoin='round' className='h-7'>
                <path d='M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z' />
