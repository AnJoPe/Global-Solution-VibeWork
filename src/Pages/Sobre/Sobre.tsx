    ...
    <>
      <div className='flex flex-col w-[90%] md:w-[85%] py-12 items-center gap-10'>
        ...
        <div className='flex flex-col w-full gap-5 px-5 md:px-10'>
          <Pergunta
            pergunta='O VibeWork é apenas um organizador de tarefas?'
            resposta='Não. O VibeWork vai além das agendas convencionais: integra planejamento semanal entre remoto e presencial, envia lembretes personalizados de pausa, permite check-ins de humor e bem-estar, e oferece dashboards com métricas para autoconhecimento. Tudo pensado para promover um equilíbrio saudável na rotina profissional e pessoal.'
          />
          <Pergunta
            pergunta='Meus dados e registros ficam privados?'
            resposta='Sim. Todos os dados de rotina, bem-estar e produtividade salvos no VibeWork pertencem apenas ao usuário. Não são compartilhados com terceiros ou com a empresa, exceto se o próprio usuário optar por algum recurso empresarial ou relatório coletivo em um plano corporativo.'
          />
          <Pergunta
            pergunta='Posso personalizar meus horários, notificações e tipos de pausa?'
            resposta='Sim! O VibeWork permite que cada usuário ajuste sua agenda, configure horários de trabalho ou folga, defina tipos e frequência das pausas, além de receber notificações conforme sua preferência.'
          />
          <Pergunta
            pergunta='O sistema funciona para quem trabalha só presencialmente ou só remotamente?'
            resposta='Sim. Embora VibeWork seja ideal para regimes híbridos, qualquer profissional pode usar a plataforma para organizar a própria rotina, fazer registros de bem-estar e acompanhar seus hábitos de trabalho, independentemente do formato de atuação.'
          />
        </div>
      </div>
    </>
